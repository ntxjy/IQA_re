...
from classification.models.mamba2.ssd_minimal import WITH_TRITON

# check the version of pytorch, if it is larger than 2.1.0, set WITH_TRITON to be True, otherwise, False
try:
    from distutils.version import LooseVersion
    is_greater_than_2_1 = LooseVersion(torch.__version__) > LooseVersion("2.1.2")
    if is_greater_than_2_1:
        WITH_TRITON = True
    else:
        WITH_TRITON = False
except:
